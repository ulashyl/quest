...
const ThirdPage = () => {
  ...
  const numbersData = {
    ...
    2: {
      ...
      description:
        "Придумайте загадку, чтобы запутать разум Рогатого Бога (тема отчета) (4 балла)",
    },
    3: {
      title: "Число 3 - Творчество",
      description:
        "Выполните домашнее задание (основу) по любой дисциплине из вашего индивидуального расписания (скриншот в теме отчета) (6 баллов)",
    },
    4: {
