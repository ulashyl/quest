...
const ThirdPage = () => {
  ...
  const numbersData = {
    1: {
     title: "37",
      description:
        "Отсеките лишнее и получите слово. Отсекаем только цифры, без жертвоприношений - мы живём в цивилизованном обществе. 872П036Л186О142Д473О296Р073О758Д148И597Е000 (2 балла)",
    },
    2: {
      title: "38",
      description:
