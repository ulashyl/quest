...
const ThirdPage = () => {
  ...
  const numbersData = {
    ...
    6: {
      title: "87",
      description:
        "Одно из мест в Запретном лесу оказалось по-особому опасным для некоторых учеников в октябре. Придумайте, как сделать его безопаснее для обитателей (ссылка на пост в загаданной локации или напишите план по устранению опасности сразу в теме) (6 баллов)",
    },
    7: {
      title: "88",
      description:
